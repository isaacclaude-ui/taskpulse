        ...
        <div className="header-banner-content px-2 sm:px-4 py-3 sm:py-6">
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1 sm:gap-2 md:gap-3 flex-shrink-0">
              ...
              {/* Admin/Team Admin button with gear icon and pending badge (admin only) */}
              {(member?.role === 'admin' || member?.role === 'lead') && (
                <button
                  onClick={() => router.push('/admin')}
                  className="relative flex items-center justify-center text-sm bg-white/10 text-white p-2 lg:py-2 lg:px-4 rounded-lg hover:bg-white/20 transition-colors font-medium"
                  title={member?.role === 'admin' && pendingCount > 0 ? `Admin (${pendingCount} pending)` : member?.role === 'lead' ? 'Team Admin' : 'Admin'}
                >
              ...
              {member && (
                <button
                  ...
                  className="flex items-center justify-center text-sm bg-white/10 text-white p-2 lg:py-2 lg:px-4 rounded-lg hover:bg-white/20 transition-colors font-medium"
                  title="Notifications"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="flex items-center justify-center text-sm bg-white text-teal-700 p-2 lg:py-2 lg:px-4 rounded-lg hover:bg-white/90 transition-colors font-medium"
                title="Add Log Entry"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
                <span className="hidden lg:inline ml-2">Add Log</span>
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3" style={{ minHeight: '16vh' }}>
          ...
          <div className="glass-card rounded-xl p-3 flex flex-col overflow-hidden">
            <div className="flex items-center justify-between mb-2 gap-1">
              <h2 className="text-sm font-bold text-slate-800 flex items-center gap-1 flex-shrink-0">
              ...
              <div className="flex items-center gap-0">
                ...
                <span className="text-[9px] font-medium text-slate-600 min-w-[50px] text-center">
                ...
                <button
                  ...
                  className="ml-0.5 px-1 py-0.5 text-[9px] text-teal-600 hover:bg-teal-50 rounded font-medium"
                  title="Go to today"
                >
                  Today
                </button>
      ...
      <main className="max-w-full lg:max-w-7xl mx-auto px-4 py-6 overflow-x-auto">
        ...
        {loading ? (
          ...
          <PipelineGrid
            ...
            isAdmin={member?.role === 'admin' || member?.role === 'lead'}
