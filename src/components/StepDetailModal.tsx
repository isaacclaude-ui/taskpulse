              ...
              <div className="mb-6 space-y-2">
                ...
                {prevStep && (
                  <button
                    ...
                    className="w-full py-2.5 px-4 bg-gradient-to-r from-slate-500 via-slate-400 to-slate-500 text-white rounded-lg hover:from-slate-600 hover:via-slate-500 hover:to-slate-600 transition-all shadow-sm flex items-center justify-center gap-2 text-sm font-medium"
                  >
